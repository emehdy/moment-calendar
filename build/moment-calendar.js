...
Hijri.picker=function(ele,options){
	...
	self.temp='<div class="date-show"></div><div class="date-container"><table class="controls" width=100%><tr><td width=35><a class="btn btn-default" data-toggle="datepicker" data-method="subtract" data-type="iMonth"><i class="fa fa-angle-left"></i></a></td><td width=80><input type=number class="form-control input-sm"></td><td><select class="form-control input-sm"></select></td><td width=5></td><td width=35><a data-toggle="datepicker" data-method="add" data-type="iMonth" class="btn btn-default"><i class="fa fa-angle-right"></i></a></td><td width=35><a class="btn btn-default btn-sm clear"><i class="fa fa-ban"></i></a></td></tr></table><div class="row table-responsive"><table class="table table-bordered calendar"><thead/><tbody/></table></div></div>';
	...
	{	
		...
		$.each(moment.localeData('en')._iMonths	,function(x,iMonth){
			 self.month.append(
